...
class Pais extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'ligas' => array(self::HAS_MANY, 'Liga', 'pais'),
			'personas' => array(self::HAS_MANY, 'Persona', 'pais'),
			'provincias' => array(self::HAS_MANY, 'Provincia', 'pais'),
		);
	}
	/**
    ...
    public static function getPaises($clave) {
            return  CHtml::listData(Pais::model()->findAll(),$clave,'nombre');
        }
}
