...
class Rubro extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'analisises' => array(self::HAS_MANY, 'Analisis', 'rubro'),
			'productos' => array(self::MANY_MANY, 'Producto', 'rubro_calculo_valor(rubro, producto)'),
		);
	}
	/**
	...
	public static function getRubros($clave) {
		return  CHtml::listData(Rubro::model()->findAll(),$clave,'descripcion');
	}
}
