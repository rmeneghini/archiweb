 ...
 *
 * The followings are the available columns in table 'tipo_entidad':
 * @property integer $id
 ...
 */
class TipoEntidad extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'entidads' => array(self::HAS_MANY, 'Entidad', 'tipo_entidad'),
		);
	}
	 ...
	 * @return TipoEntidad the static model class
	 */
