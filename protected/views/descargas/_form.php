...
<?php 
    echo $form->textFieldGroup($model, 'kg_brutos_destino', array('widgetOptions' => array('htmlOptions' => array(
    'onChange' => ' Descargas.calculoNeto();'
    )))); 
?>

<?php 
    echo $form->textFieldGroup($model, 'kg_tara_destino', array('widgetOptions' => array('htmlOptions' => array(
    'onChange' => ' Descargas.calculoNeto();'
)))); 
?>
...
<?php 
    echo $form->textFieldGroup($model, 'porcentaje_humedad', array('widgetOptions' => array('htmlOptions' => array(
    'ajax' => array(
...
<?php
echo $form->switchGroup($model, 'fumigado', array(
    'widgetOptions' => array(
        'options' => array(
            'onText' => 'SI',
            'offText' => 'NO',
