					...
					'items' => array(
						array(
							...
							'items' => array(
								...
								array(
									'label' => 'Acciones', 'url' => '#', 'visible' => Yii::app()->authManager->checkAccess('cliente', Yii::app()->user->id),
									'items' => array(
								...
								array(
									'label' => ' ', 'icon' => 'user', 'url' => '#', 'visible' => Yii::app()->authManager->checkAccess('cliente', Yii::app()->user->id),
									'items' => array(
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="widget-content">
								...
								<p><a href='https://wa.me/543582435921/?text='>WhatsApp</a></p>
