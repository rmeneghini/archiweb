						...
						array(
							...
							'items'=>array(
								...
								array('label'=>'Acciones', 'url'=>'#', 'visible'=>Yii::app()->authManager->checkAccess('admin',Yii::app()->user->id),
									'items'=>array(
										array('label'=>'Usuarios', 'url'=>array('/usuario/admin'),'visible'=>Yii::app()->authManager->checkAccess('admin',Yii::app()->user->id)),
										...
										array('label'=>'Importación', 'url'=>array('/site/importar'),'visible'=>Yii::app()->authManager->checkAccess('admin',Yii::app()->user->id)),
										)),
								array('label'=>'Panel', 'icon'=>'cog','url'=> (Yii::app()->authManager->isAssigned('admin',Yii::app()->user->id))? array('administrador/admin'): array('descargas/index'), 'visible'=>Yii::app()->authManager->checkAccess('cliente',Yii::app()->user->id)),
